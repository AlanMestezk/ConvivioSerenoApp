            ...
            <section className={styles.content}>
                ...
                <div className={styles.divContent}>
                    ...
                    <h3 className={styles.textContent}>
                        Convivio Sereno é uma instituição dedicada a proporcionar um ambiente seguro, acolhedor e estimulante para a população idosa. Com uma equipe de profissionais qualificados e uma infraestrutura pensada para atender às necessidades dos idosos, o centro oferece uma variedade de atividades e serviços especialmente planejados para promover um envelhecimento ativo e saudável.
                    </h3>
